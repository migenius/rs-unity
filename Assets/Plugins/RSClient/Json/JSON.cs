...
namespace com.migenius.util
{
    ...
    public class JSON
    {
		...
		public static void setLegacyMode(bool mode)
		{
			legacyMode = mode;
		}
		public static bool getLegacyMode()
		{
			return legacyMode;
		}
        ...
        {
			if(legacyMode && aString.Length > 2)
			{
				char first = aString[0];
